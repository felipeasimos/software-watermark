...
void* watermark_decode_improved8(GRAPH*, uint8_t* key, unsigned long* num_bytes);
void* watermark_decode_improved(GRAPH*, uint8_t* key, unsigned long* num_bits);
...
void* watermark_rs_decode_improved8(GRAPH*, void* key, unsigned long* num_bytes, unsigned long num_parity_symbols);
void* watermark_rs_decode_improved(GRAPH*, void* key, unsigned long* num_data_symbols, unsigned long num_parity_symbols, unsigned long symsize);
