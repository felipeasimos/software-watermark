...
void rs_encode(uint8_t* data, int data_len, uint16_t* parity, int parity_len) {

	struct rs_control* rs = get_rs_struct(parity_len);
...
int rs_decode(uint8_t* data, int data_len, uint16_t* parity, int parity_len) {
